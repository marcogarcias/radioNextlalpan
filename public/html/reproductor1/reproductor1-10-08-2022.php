<?php
$web = 'public/html/reproductor1';
$img = $web.'/img';
?>
<link rel="stylesheet" type="text/css" href="<?php echo $web ?>/css/reproductor1.css?<?php echo microtime(); ?>">
<div class="rep2">
  ...
  <div class="border rep2-footer">
    <div class="border2 rep2-foot-eslogan">
      <div class="rep2-radionextlalpan">RADIO <br> NETXLALPAN</div>
    </div>
    <div class="border2 rep2-foot-volumen">
    ...
    <div class="border2 rep2-foot-social">
      ...
      <div class="rep2-social" data-social="whatsapp"><a href="https://api.whatsapp.com/send?phone=525549187591" target="_blanck"><img src="<?php echo $img; ?>/reproductor2/rep-btn-whatsapp-1.png?<?php echo microtime(); ?>" title="Whatsapp" alt="Whatsapp"></a></div>
    </div>
  </div>
</div>

<script ></script>
<script src="<?php echo $web ?>/js/reproductor1.js?<?php echo microtime(); ?>"></script>