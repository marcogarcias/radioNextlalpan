						...
						<form name="login" method="post" class="form-horizontal" id="patrocinadoresAddForm" enctype="multipart/form-data">
							...
							<div class="form-group has-feedback" id="patrocinador-group">
								<div class="col-md-12">
									...
									<input type="text" name="patrocinador" id="patrocinador" class="form-control" placeholder="Nombre del patrocinador" data-notnull="1" />
							...
							<div class="form-group has-feedback" id="colonia-group">
								<div class="col-md-12">
									...
									<input type="text" name="colonia" id="colonia" class="form-control" placeholder="Nombre de la colonia" data-notnull="1" />
							...
							<div class="form-group has-feedback" id="calle-group">
								<div class="col-md-12">
									...
									<input type="text" name="calle" id="calle" class="form-control" placeholder="Nombre de la calle" data-notnull="1" />
							...
							<div class="form-group has-feedback" id="numero-group">
								<div class="col-md-12">
									...
									<input type="text" name="numero" id="numero" class="form-control" placeholder="Número" data-notnull="1" />
							...
							<div class="form-group has-feedback" id="cp-group">
								<div class="col-md-12">
									...
									<input type="text" name="cp" id="cp" class="form-control" placeholder="Código Postal" data-notnull="1" />
							...
							<div class="form-group has-feedback" id="referencias-group">
								<div class="col-md-12">
									...
									<input type="text" name="referencias" id="referencias" class="form-control" placeholder="Referencias" data-notnull="0" />
							...
							<div class="form-group has-feedback" id="telefono-group">
								<div class="col-md-12">
									...
									<input type="text" name="telefono" id="telefono" class="form-control" placeholder="Telefono" data-notnull="0" />
							...
							<div class="form-group has-feedback" id="movil-group">
								<div class="col-md-12">
									...
									<input type="text" name="movil" id="movil" class="form-control" placeholder="Telefono Movil" data-notnull="0" />
							...
							<div class="form-group has-feedback" id="web-group">
								<div class="col-md-12">
									...
									<input type="text" name="web" id="web" class="form-control" placeholder="Dirección de página web" data-notnull="0" />
							...
							<div class="form-group has-feedback" id="facebook-group">
								<div class="col-md-12">
									...
									<input type="text" name="facebook" id="facebook" class="form-control" placeholder="Facebook" data-notnull="0" />
							...
							<div class="form-group has-feedback" id="twitter-group">
								<div class="col-md-12">
									...
									<input type="text" name="twitter" id="twitter" class="form-control" placeholder="Twitter" data-notnull="0" />
